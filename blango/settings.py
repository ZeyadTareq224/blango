...
class Dev(Configuration):
  ...
  MIDDLEWARE = [
    ...
    #'django.middleware.csrf.CsrfViewMiddleware', Codio settings only
    'django.contrib.auth.middleware.AuthenticationMiddleware',
    'django.contrib.messages.middleware.MessageMiddleware',
    #'django.middleware.clickjacking.XFrameOptionsMiddleware', Codio settings only
  ]
